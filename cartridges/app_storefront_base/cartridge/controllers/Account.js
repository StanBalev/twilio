...
server.get(
    ...
    function (req, res, next) {
        ...
        profileForm.customer.country.value = accountModel.profile.country || "No country";
        profileForm.customer.interests.value = accountModel.profile.interests || "Guy without hobby";
